...
| uvloop | `python_uvloop_3.14` | `python_uvloop_3.15` | wall-time + task name (3.15 from sdist) |
...
```
python_(cpu|alloc|asyncio|native_cpu|deep_stack|gil_contention|uvloop|exceptions|async_gen|lock|live_heap)_3\.(14|15)
```
...
TEST_SCENARIOS='python_(cpu|alloc|asyncio|native_cpu|deep_stack|gil_contention|uvloop|exceptions|async_gen|lock|live_heap)_3\.(14|15)' go test -v -run TestScenarios
```
