...
Pair: `python_asyncio_3.14` / `python_asyncio_3.15`. Same workload and expectations as 3.14 (`scenarios/python_asyncio/main.py`, `profile.json`).

Expectation tables: see `python_asyncio_3.14/README.md`. 3.15 not re-burned on main CI until manylinux cp315 wheel lands.
